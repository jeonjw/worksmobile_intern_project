...
public class PhotoContentsJob extends JobService {
    ...
    static {
        JobInfo.Builder builder = new JobInfo.Builder(103,
                new ComponentName("com.worksmobile.wm_project", PhotoContentsJob.class.getName()));
    ...
    final Runnable mWorker = new Runnable() {
        @Override
        public void run() {
            if (isScheduled(PhotoContentsJob.this)) {
                cancelJob(PhotoContentsJob.this);
            }
            scheduleJob(PhotoContentsJob.this);
    ...
    public boolean onStartJob(JobParameters params) {
        ...
        System.out.println("PHOTOS : " + sb.toString());
    ...
    public boolean onStopJob(JobParameters params) {
        System.out.println("ON STOP PHOTO JOB");
